...
void setup_logging()
{
    ...
    // create FileAppender
    LOG4CXX_DECODE_CHAR(fileName, "amis.log");
    ...
    // set higher log level for xmlreader
    log4cxx::LoggerPtr xmlreader = log4cxx::Logger::getLogger("kolibre.xmlreader");
    xmlreader->setLevel(log4cxx::Level::getWarn());
