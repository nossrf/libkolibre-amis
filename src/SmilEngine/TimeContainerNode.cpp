 ...
 */
//--------------------------------------------------
TimeContainerNode::TimeContainerNode()
{
    mNumChildren = 0;
    mpFirstChild = NULL;
    mSkipOptionName = "";
...
//--------------------------------------------------
void TimeContainerNode::addChild(Node* pNode)
{
 ...
 */
//--------------------------------------------------
void TimeContainerNode::setSkipOption(string skipOptionName)
{
    //cerr << "Setting skipoption " << skipOptionName << " for node " << this->getElementId() << endl;
...
//--------------------------------------------------
string TimeContainerNode::getSkipOption()
{
...
//--------------------------------------------------
Node* TimeContainerNode::getChild(int index)
{
    //local variables
    Node* p_tmp_node;
...
//--------------------------------------------------
int TimeContainerNode::NumChildren()
{
    return mNumChildren;
}
 ...
 */
//--------------------------------------------------
bool TimeContainerNode::setAtId(string id)
{
    int i;
    int len = NumChildren();
    bool b_found = false;
 ...
 */
//--------------------------------------------------
NodeType TimeContainerNode::getCategoryOfNode()
{
